...
global c0 N lambda delta_f Ts Mr Mt
...
K_vec = [14,28,42,56,70]; % correspond to the parameter 'K' in the paper
N1 = N*p1;
...
E = zeros(numel(K_vec),num_trial); 
RMSE_range0 = E; RMSE_range1 = E; RMSE_range2 = E; RMSE_range3 = E; RMSE_range4 = E; RMSE_range20 = E; rcrb_range = E;
RMSE_angle0 = E; RMSE_angle1 = E; RMSE_angle2 = E; RMSE_angle3 = E; RMSE_angle4 = E; RMSE_angle20 = E; rcrb_angle = E;
RMSE_veloc0 = E; RMSE_veloc1 = E; RMSE_veloc2 = E; RMSE_veloc3 = E; RMSE_veloc4 = E; RMSE_veloc20 = E; rcrb_veloc = E;
...
for i_k = 1:length(K_vec)
    ...
    parfor trial = 1:num_trial
        ...
        RMSE_angle4(i_k, trial) = cal_RMSE(Angle4*pi/180, Angle*pi/180);
        RMSE_range4(i_k, trial) = cal_RMSE(Range4, Range);
        ...
        RMSE_angle1(i_k, trial) = cal_RMSE(Angle1*pi/180, Angle*pi/180);
        RMSE_range1(i_k, trial) = cal_RMSE(Range1, Range);
        RMSE_veloc1(i_k, trial) = cal_RMSE(Veloc1, Veloc);
        ...
        RMSE_angle0(i_k, trial) = cal_RMSE(Angle0*pi/180, Angle*pi/180);
        RMSE_range0(i_k, trial) = cal_RMSE(Range0, Range);
        RMSE_veloc0(i_k, trial) = cal_RMSE(Veloc0, Veloc);
        ...
        RMSE_angle2(i_k, trial) = cal_RMSE(Angle2*pi/180, Angle*pi/180);
        RMSE_range2(i_k, trial) = cal_RMSE(Range2, Range);
        RMSE_veloc2(i_k, trial) = cal_RMSE(Veloc2, Veloc);
        ...
        RMSE_angle2part2(i_k, trial) = cal_RMSE(Angle2part2*pi/180, Angle*pi/180);
        RMSE_range2part2(i_k, trial) = cal_RMSE(Range2part2, Range);
        RMSE_veloc2part2(i_k, trial) = cal_RMSE(Veloc2part2, Veloc);
        ...
        RMSE_angle3(i_k, trial) = cal_RMSE(Angle3*pi/180, Angle*pi/180);
        RMSE_range3(i_k, trial) = cal_RMSE(Range3, Range);
        RMSE_veloc3(i_k, trial) = cal_RMSE(Veloc3, Veloc);

        [rcrb_angle(i_k,trial),rcrb_range(i_k,trial),rcrb_veloc(i_k,trial)] = ...
...
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'14','28','42','56','70'},'XLim',[1,5],'YLim',[0.00034,0.01],'YTick',[1e-3,1e-2]);
...
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'14','28','42','56','70'},'XLim',[1,5],'YLim',[0.01,0.37],'YTick',[1e-2,1e-1]); 
empty_patch = patch([0 0 1 1], [0 1 1 0], 'w', 'EdgeColor', 'none'); hold on;
...
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'14','28','42','56','70'},'XLim',[1,5],'YLim',[0.065,1.8],'YTick',[1e-1,1e0]);
