...
for i_snr = 1:length(SNRs)
    ...
    parfor trial = 1:num_trial
        ...
        mask = generate_mask_Type2(p2,trial,Mr,N,K,N1,K1); % binary mask for the time-frequency resource
...
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'0','5','10','15','20','25','30'},'YLim',[0.000022,0.01]); 
...
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'0','5','10','15','20','25','30'},'YLim',[0.0006,0.5]); 
empty_patch = patch([0 0 1 1], [0 1 1 0], 'w', 'EdgeColor', 'none'); hold on;
...
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'0','5','10','15','20','25','30'},'YLim',[0.005,1]);
