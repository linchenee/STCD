...
%% Scenario setting
SNR = 5;
p1 = [0.2 0.3 0.5 0.7 0.9]; % correspond to the parameter 'p_1' in the paper
...
for i_p1 = 1:length(p1)
    ...
    parfor trial = 1:num_trial
        ...
        RMSE_angle4(i_p1, trial) = cal_RMSE(Angle4*pi/180, Angle*pi/180);
        RMSE_range4(i_p1, trial) = cal_RMSE(Range4, Range);
        ...
        RMSE_angle1(i_p1, trial) = cal_RMSE(Angle1*pi/180, Angle*pi/180);
        RMSE_range1(i_p1, trial) = cal_RMSE(Range1, Range);
        RMSE_veloc1(i_p1, trial) = cal_RMSE(Veloc1, Veloc);
        ...
        RMSE_angle0(i_p1, trial) = cal_RMSE(Angle0*pi/180, Angle*pi/180);
        RMSE_range0(i_p1, trial) = cal_RMSE(Range0, Range);
        RMSE_veloc0(i_p1, trial) = cal_RMSE(Veloc0, Veloc);
        ...
        RMSE_angle2(i_p1, trial) = cal_RMSE(Angle2*pi/180, Angle*pi/180);
        RMSE_range2(i_p1, trial) = cal_RMSE(Range2, Range);
        RMSE_veloc2(i_p1, trial) = cal_RMSE(Veloc2, Veloc);
        ...
        RMSE_angle2part2(i_p1, trial) = cal_RMSE(Angle2part2*pi/180, Angle*pi/180);
        RMSE_range2part2(i_p1, trial) = cal_RMSE(Range2part2, Range);
        RMSE_veloc2part2(i_p1, trial) = cal_RMSE(Veloc2part2, Veloc);
        ...
        RMSE_angle3(i_p1, trial) = cal_RMSE(Angle3*pi/180, Angle*pi/180);
        RMSE_range3(i_p1, trial) = cal_RMSE(Range3, Range);
        RMSE_veloc3(i_p1, trial) = cal_RMSE(Veloc3, Veloc);

        [rcrb_angle(i_p1,trial),rcrb_range(i_p1,trial),rcrb_veloc(i_p1,trial)] = ...
...
xlabel('{\itp}_1', 'FontName', 'Times New Roman','FontSize', 18);
ylabel('RMSE (rad)', 'FontName', 'Times New Roman','FontSize', 18);
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'0.2','0.3','0.5','0.7','0.9'},'XLim',[1,5],'YLim',[0.00033,0.01]); 
...
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'0.2','0.3','0.5','0.7','0.9'},'XLim',[1,5],'YLim',[0.01,1]); 
empty_patch = patch([0 0 1 1], [0 1 1 0], 'w', 'EdgeColor', 'none'); hold on;
...
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'0.2','0.3','0.5','0.7','0.9'},'XLim',[1,5],'YLim',[0.07,1.6]);
