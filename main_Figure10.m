...
E = zeros(numel(num_tar),num_trial); 
...
for i_tar = 1:length(num_tar)
    L = num_tar(i_tar);
    fprintf('The %dth target\n',i_tar);
    parfor trial = 1:num_trial
        ...
        RMSE_angle4(i_tar, trial) = cal_RMSE(Angle4*pi/180, Angle*pi/180);
        RMSE_range4(i_tar, trial) = cal_RMSE(Range4, Range);
        ...
        RMSE_angle1(i_tar, trial) = cal_RMSE(Angle1*pi/180, Angle*pi/180);
        RMSE_range1(i_tar, trial) = cal_RMSE(Range1, Range);
        RMSE_veloc1(i_tar, trial) = cal_RMSE(Veloc1, Veloc);
        ...
        RMSE_angle0(i_tar, trial) = cal_RMSE(Angle0*pi/180, Angle*pi/180);
        RMSE_range0(i_tar, trial) = cal_RMSE(Range0, Range);
        RMSE_veloc0(i_tar, trial) = cal_RMSE(Veloc0, Veloc);
        ...
        RMSE_angle2(i_tar, trial) = cal_RMSE(Angle2*pi/180, Angle*pi/180);
        RMSE_range2(i_tar, trial) = cal_RMSE(Range2, Range);
        RMSE_veloc2(i_tar, trial) = cal_RMSE(Veloc2, Veloc);
        ...
        RMSE_angle2part2(i_tar, trial) = cal_RMSE(Angle2part2*pi/180, Angle*pi/180);
        RMSE_range2part2(i_tar, trial) = cal_RMSE(Range2part2, Range);
        RMSE_veloc2part2(i_tar, trial) = cal_RMSE(Veloc2part2, Veloc);
        ...
        RMSE_angle3(i_tar, trial) = cal_RMSE(Angle3*pi/180, Angle*pi/180);
        RMSE_range3(i_tar, trial) = cal_RMSE(Range3, Range);
        RMSE_veloc3(i_tar, trial) = cal_RMSE(Veloc3, Veloc);

        [rcrb_angle(i_tar,trial),rcrb_range(i_tar,trial),rcrb_veloc(i_tar,trial)] = ...
...
xlabel('\itL', 'FontName', 'Times New Roman','FontSize', 18);
ylabel('RMSE (rad)', 'FontName', 'Times New Roman','FontSize', 18);
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'1','2','3','4','5'},'XLim',[1,5],'YLim',[0.0002,0.029],'YTick',[1e-3,1e-2]);
...
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'1','2','3','4','5'},'XLim',[1,5],'YLim',[0.007,1],'YTick',[1e-2,1e-1,1e0]); 
empty_patch = patch([0 0 1 1], [0 1 1 0], 'w', 'EdgeColor', 'none'); hold on;
...
set(gca, 'FontName', 'Times New Roman','FontSize', 18, 'XTickLabel',{'1','2','3','4','5'},'XLim',[1,5],'YLim',[0.055,1.3],'YTick',[1e-1,1e0]);
